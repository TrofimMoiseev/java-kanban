...
public class FileBackedTaskManagerTest {
    ...
    void testSaveAndLoad() throws ManagerSaveException {
        // Создание задачи
        Task task1 = new Task("Task 1", "Description of task", TaskStatus.NEW, 5L,
                LocalDateTime.of(2025, 3, 16, 10, 30, 0));
        Epic epic1 = new Epic("Epic 1", "Description of epic");
        Task task2 = new Task("Task 2", "Description of task", TaskStatus.NEW, 5L,
        ...
        Task task3 = new Task("Task 2", "Description of task", TaskStatus.NEW, 5L,
    ...
    @Test
    void testAddTask() {
        Task task = new Task("New Task", "Task description", TaskStatus.NEW, 5L,
                LocalDateTime.of(2025, 3, 16, 10, 30, 0));
        task.setId(1);
    ...
    void testDeleteTask() throws ManagerSaveException {
        Task task = new Task("Task to delete", "Delete description", TaskStatus.NEW, 5L,
                LocalDateTime.of(2025, 3, 16, 10, 30, 0));
        task.setId(1);
